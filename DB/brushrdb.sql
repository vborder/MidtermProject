...
INSERT INTO `beer_recipe` (`id`, `beer_name`, `beer_type`, `yeast`, `description`, `enabled`, `created_at`, `updated_at`, `img_url`, `user_id`) VALUES (DEFAULT, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'resources/media/', 2);
INSERT INTO `beer_recipe` (`id`, `beer_name`, `beer_type`, `yeast`, `description`, `enabled`, `created_at`, `updated_at`, `img_url`, `user_id`) VALUES (DEFAULT, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'resources/media/', 1);
INSERT INTO `beer_recipe` (`id`, `beer_name`, `beer_type`, `yeast`, `description`, `enabled`, `created_at`, `updated_at`, `img_url`, `user_id`) VALUES (DEFAULT, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'resources/media/', 3);
INSERT INTO `beer_recipe` (`id`, `beer_name`, `beer_type`, `yeast`, `description`, `enabled`, `created_at`, `updated_at`, `img_url`, `user_id`) VALUES (DEFAULT, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'resources/media/', 2);
